...
- **Le compromis chiffré** : la portance gagne +203 % *et* la traînée baisse de 18 %. Les deux termes s'améliorent à la fois — cas favorable, qui tient ici à ce que la surface de référence suit la corde.
...
Exporté le 20/08/2026 à 10:56 UTC par `scripts/export_best.py`.
