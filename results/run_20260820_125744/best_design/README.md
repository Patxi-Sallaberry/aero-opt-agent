...
Meilleure des **2 itérations** de la série `iterations` (2 réussies, 0 échouée), retenue sur l'objectif `maximize_Cl_Cd`.
...
| **Optimisé (itération 0)** | **0.05081** | **0.17500** | **3.44** |
...
- **Le compromis chiffré** : Cl +0 %, Cd +0 %.
