...
Meilleure des **20 itérations** de la série `iterations` (17 réussies, 3 échouées), retenue sur l'objectif `maximize_Cl_Cd`.
...
| **Optimisé (itération 16)** | **0.03665** | **0.21220** | **5.79** |

**Gain de finesse : +68.1 %**
...
| `camber` | 0.02 | **0.0231** unitless | +15.5 % | 0 … 0.09 |
...
| | seed | optimisé | écart |
|---|---|---|---|
| **Portance Cl** | 0.1750 | **0.2122** | +21.3 % ✓ |
| **Traînée Cd** | 0.05081 | **0.03665** | -27.9 % ✓ |
| **Finesse Cl/Cd** | 3.44 | **5.79** | +68.1 % ✓ |
...
- **Cambrure accentuée** (0.0200 → 0.0231). La cambrure décale toute la courbe de portance : un profil cambré porte déjà à incidence nulle. Elle se paie en traînée de forme et en moment de tangage, d'où l'existence d'un optimum plutôt qu'une croissance sans fin.
...
- **Le compromis chiffré** : la portance gagne +21 % *et* la traînée baisse de 28 %. Les deux termes s'améliorent à la fois — cas favorable, qui tient ici à ce que la surface de référence suit la corde.
...
| 7 | — | — | — | échec — maillage invalide |
| 8 | 0.05065 | 0.21220 | 4.19 | OK |
| 9 | 0.05077 | 0.18448 | 3.63 | OK |
| 10 | 0.05402 | 0.20943 | 3.88 | OK |
| 11 | 0.05038 | 0.21220 | 4.21 | OK |
| 12 | 0.04704 | 0.21220 | 4.51 | OK |
| 13 | 0.04397 | 0.21220 | 4.83 | OK |
| 14 | 0.04115 | 0.21220 | 5.16 | OK |
| 15 | 0.03855 | 0.21220 | 5.50 | OK |
| 16 ⭐ | 0.03665 | 0.21220 | 5.79 | OK |
| 17 | 0.03677 | 0.18448 | 5.02 | OK |
| 18 | — | — | — | échec — maillage invalide |
| 19 | — | — | — | échec — maillage invalide |
