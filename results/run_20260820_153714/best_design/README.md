...
Meilleure des **10 itérations** de la série `iterations` (10 réussies, 0 échouée), retenue sur l'objectif `maximize_Cl_Cd`.
...
| **Optimisé (itération 8)** | **0.05060** | **0.22540** | **4.45** |

**Gain de finesse : +29.3 %**
...
| **Traînée Cd** | 0.05081 | **0.05060** | -0.4 % ✓ |
| **Finesse Cl/Cd** | 3.44 | **4.45** | +29.3 % ✓ |
...
- **Le compromis chiffré** : la portance gagne +29 % *et* la traînée baisse de 0 %. Les deux termes s'améliorent à la fois — cas favorable, qui tient ici à ce que la surface de référence suit la corde.
